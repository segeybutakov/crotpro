...
$string['cleantables_help'] = 'Будут удалены все таблицы Крота за исключением настроек Крота для заданий! ';

$string['newexplain'] = 'For more information on this plugin see: ';
$string['crot'] = 'Крот';
$string['crotexplain'] = 'Крот - модуль проверки на плагиат: он проводит сравнение как файлов, скопированных у студентов этого же учебного заведения, так и файлов, скопированных из интернета. <br/><br/> Более подробную информацию смотрите на <a href="http://www.crotsoftware.com">www.crotsoftware.info</a>';
